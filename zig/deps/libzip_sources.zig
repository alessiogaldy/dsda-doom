// Core source list from upstream libzip lib/CMakeLists.txt (add_library(zip ...)).
// Excludes zip_err_str.c, which is generated, and the Windows/crypto/bzip2/
// lzma/zstd conditional sources -- dsda only needs deflate via zlib.
...
pub const unix = [_][]const u8{ "zip_source_file_stdio_named.c", "zip_random_unix.c" };
