// Source lists from upstream cmake/libxmp-sources.cmake.
// core + prowizard + depackers is the full (non-lite) libxmp, matching what
// Homebrew's libxmp ships, so module format support is unchanged.
...
pub const prowizard = [_][]const u8{
...
pub const depackers = [_][]const u8{
