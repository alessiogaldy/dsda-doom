...
cfg_def_t cfg_defs[] =
{
  ...
  MIGRATED_SETTING(dsda_config_steam_controller_trackpad_aim),
  MIGRATED_SETTING(dsda_config_steam_controller_trackpad_sensitivity_x),
  MIGRATED_SETTING(dsda_config_steam_controller_trackpad_sensitivity_y),
